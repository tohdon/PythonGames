...
def snap(event):
    ...
    if valid:
        ...
        shape = c.create_text(200, 200, text="SNAP! You wins 1 point!")
    else:
        if event.char == 'q':
            player1_score = player1_score-1
        else:
...
shapes.append(rect)
rect = c.create_rectangle(35, 100, 365, 270, outline='green', fill='green', state=HIDDEN)
shapes.append(rect)
rect = c.create_rectangle(35, 100, 365, 270, outline='blue', fill='blue', state=HIDDEN)
shapes.append(rect)
c.pack()
sq = c.create_rectangle(35, 20, 365, 350, outline='black', fill='black', state=HIDDEN)
shapes.append(sq)
sq = c.create_rectangle(35, 20, 365, 350,  outline='red', fill='red', state=HIDDEN)
shapes.append(sq)
sq = c.create_rectangle(35, 20, 365, 350, outline='green', fill='green', state=HIDDEN)
shapes.append(sq)
sq = c.create_rectangle(35, 20, 365, 350, outline='blue', fill='blue', state=HIDDEN)
shapes.append(sq)
c.pack()
